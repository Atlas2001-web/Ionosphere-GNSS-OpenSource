#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Merge routine_finds_20260916.json into PROJECTS.json and regenerate docs."""
...
FINDS_PATH = ROOT / "research" / "routine_finds_20260916.json"
LISTS = ROOT / "lists"
DOCS = ROOT / "docs"
...
def finalize_new(f: dict) -> dict:
    ...
    return {
        ...
        "markers": f.get("markers") or ["routine-2026-09-16"],
        "stars_approx": f.get("stars"),
        "source": "routine-web-search-2026-09-16",
