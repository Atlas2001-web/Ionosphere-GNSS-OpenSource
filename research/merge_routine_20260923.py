#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Merge routine_finds_20260923.json into PROJECTS.json and regenerate docs."""
...
def finalize_new(f: dict) -> dict:
    ...
    e = {
        ...
        "markers": f.get("markers") or ["routine-2026-09-23"],
        "stars_approx": f.get("stars_approx", f.get("stars")),
        "source": f.get("source") or "routine-web-search-2026-09-23",
...
def main():
    ...
    notes.write_text(
        ...
        + f"- 详见 `research/routine_finds_20260923.json`\n",
        encoding="utf-8",
    )
