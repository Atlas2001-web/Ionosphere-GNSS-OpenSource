#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Merge routine_finds_20260921.json into PROJECTS.json and regenerate docs."""
...
FINDS_PATH = ROOT / "research" / "routine_finds_20260921.json"
LISTS = ROOT / "lists"
DOCS = ROOT / "docs"
...
def finalize_new(f: dict) -> dict:
    ...
    e = {
        ...
        "markers": f.get("markers") or ["routine-2026-09-21"],
        "stars_approx": f.get("stars_approx", f.get("stars")),
        "source": f.get("source") or "routine-web-search-2026-09-21",
