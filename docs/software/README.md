...
本目录共有 **132 篇**操作手册（合计 **28992 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 128 | [spocc.md](./spocc.md) | GFZ 多 AC 轨道/钟差 VCE 综合（SPOCC；登记墙） | 209 | **已短硬** · **登记受限**；License **441441** B/GDPR **192047** B；GitLab `ls-remote` **EXIT 128**/`info/refs` **401**；PyPI/Docker Hub **404**；**未臆造** SP3/CLK 综合；交叉 [clkcomb](./clkcomb.md)/[gkit-bias](./gkit-bias.md)/[data-access](../data-access.md) |
...
| 128 | [rinex2bin.md](./rinex2bin.md) | RINEX→BINEX CLI（nav-solutions；crates 0.1.0） | 252 | **已短硬** · **质检复跑通过**（2026-09-24 07:06 EDT；**0.1.0**/`cc74460`；ESBC `--skip` **10821632** B / Eph×**2640**；无 skip **NotEnoughBytes**；交叉 [rinex](./rinex.md)/[rinex-cli](./rinex-cli.md)/[rnx2cggtts](./rnx2cggtts.md)）|
| 128 | [rinex2bin.md](./rinex2bin.md) | RINEX→BINEX 序列化 CLI（crates；NAV 实用/OBS WIP） | 252 | **已短硬** · crates **0.1.0**/tip **`cc74460`**；`--skip` ESBC GLO **510**/SBAS **2130**；`ESBC1770.20N.bin` **10821632 B**；忙等/4096 页；交叉 [rinex-cli](./rinex-cli.md)/[rinex](./rinex.md)/[georinex](./georinex.md)/[ubx2rinex](./ubx2rinex.md)/[rnx2cggtts](./rnx2cggtts.md) |
