...
| 105 | [pyrtklib.md](./pyrtklib.md) | 港理工 IPNL：RTKLIB 2.4.3 Python 绑定（pybind11） | 172 | **已短硬** · **质检复跑** 06:30 EDT · PyPI **0.2.7**/tip **`1c468db`**/`VER_RTKLIB` **2.4.3**；F9P `readrnx` **56934**；`pntpos` Q=**5**/ns=**4** → **22.320106847°N 114.211129029°E h=22.700 m**；前60 `pntpos_ok`=**21**；交叉 [rtklib](./rtklib.md)/[gnss_lib_py](./gnss_lib_py.md)/[graphgnsslib](./graphgnsslib.md)/[mrtklib](./mrtklib.md)
| 106 | [mrtklib.md](./mrtklib.md) | 现代化 RTKLIB 系（CLAS/MADOCA/HAS/IGS；`mrtk`） | 167 | **已短硬** · **质检复跑** 06:30 EDT · tip **`8e09166`**/ **v0.7.10**；SPP **120**×Q5 与 apt b34 首点一致；RTK **120**×Q1 **35.160880512°N** h=**74.5858** ratio≈**24.7**；交叉 [rtklib](./rtklib.md)/[great-pvt](./great-pvt.md)/[ginan](./ginan.md)/[pride-pppar](./pride-pppar.md)
| 107 | [rtklib-explorer.md](./rtklib-explorer.md) | 低成本 RTKLIB fork（demo5→EX 2.5.1） | 180 | **已短硬** · tip **`06e8644`**/`EX 2.5.1`；GSI SPP **120**×Q5 **35.160874653°N**（≠apt）；RTK **115**/Q1=**102**；交叉 [rtklib](./rtklib.md)/[mrtklib](./mrtklib.md)/[pyrtklib](./pyrtklib.md)/[rtkbase](./rtkbase.md) |
| 108 | [rtklib-b2b.md](./rtklib-b2b.md) | 北斗 PPP-B2b 解码+PPP（司南/和芯） | 189 | **已短硬** · tip **`df40c0c`**/`v1.0`；`postdecoder` **49998353** B=ref；MASK=**3602**/CLOCK=**86410**；**无 Zenodo 未跑 postppp**；交叉 [rtklib](./rtklib.md)/[b2blib](./b2blib.md)/[navdecoder](./navdecoder.md)/[rtppp-b2b](./rtppp-b2b.md)/[cssrlib](./cssrlib.md) |
