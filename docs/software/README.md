...
本目录共有 **127 篇**操作手册（合计 **27738 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 125 | [gps-sdr-sim.md](./gps-sdr-sim.md) | GPS L1 基带信号仿真（SDR 回放源） | 189 | **已短硬** · tip **`28ca29a`**/MIT/★**3468**；`gps-sdr-sim` **64016** B；2 s→**19760000** B/**12** 星；交叉 [gnss-sdr](./gnss-sdr.md)/[pocketsdr](./pocketsdr.md)/[fgi-gsrx](./fgi-gsrx.md) |
| 126 | [fgi-gsrx.md](./fgi-gsrx.md) | FGI 多星座 MATLAB 软件接收机（v2.1.3） | 186 | **已短硬** · tip **`91a40a8`**/GPL-3.0/★**192**；`.m` **224**；Chapter2 26 Msps/8-bit 实采样；**无 MATLAB 未臆造 PVT**；交叉 [gnss-sdr](./gnss-sdr.md)/[pocketsdr](./pocketsdr.md)/[gps-sdr-sim](./gps-sdr-sim.md)/[rtklib](./rtklib.md) |
