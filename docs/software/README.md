...
QC（[anubis](./anubis.md)/[gfzrnx](./gfzrnx.md)）→ [rtklib](./rtklib.md) 冒烟 →（可选 [pyrtklib](./pyrtklib.md) 脚本批处理；[mrtklib](./mrtklib.md) CLAS/MADOCA/HAS；[ginan](./ginan.md) PPP/POD；[great-pvt](./great-pvt.md)；[groops](./groops.md)；[rapppid](./rapppid.md)；[ppp-wizard](./ppp-wizard.md)；[gogps-matlab](./gogps-matlab.md)；开放服务教学 [cssrlib](./cssrlib.md)；QZSS CLAS [claslib](./claslib.md)；QZSS MADOCA [madocalib](./madocalib.md)；B2b [b2blib](./b2blib.md)/[rtklib-b2b](./rtklib-b2b.md)/[navdecoder](./navdecoder.md)/[rtppp-b2b](./rtppp-b2b.md)；异机种 Win [gsilib](./gsilib.md)）→（可选码 OSB 网解 [mcosb](./mcosb.md)/[gkit-bias](./gkit-bias.md)）→ [pride-pppar](./pride-pppar.md) + 精密产品 → 教程 [06](../tutorials/06-iono-positioning.md)
...
最近新增（用法讲解）：**mcosb**（2026-09-24 06:59 EDT；tip **`f9af2c0`**/★**11**；Octave **9.4.0** GPS DOY001：**155**+**60** 站；G01 C1C=**9.5833**/C5Q=**11.7346**≡ECU `.BIA` **648** OSB；无 MATLAB 官方 GUI；交叉 gkit-bias/great-upd/data-access/clkcomb；下一优先 **SPOCC**）。
