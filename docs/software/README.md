...
本目录共有 **95 篇**操作手册（合计 **21640 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 92 | [gsilib.md](./gsilib.md) | GSI 多 GNSS 基线/PPP（IFB/ISB；Win） | 189 | **已短硬** · ver **1.0.3**；IFB tr02 **1921**/G01 C1C=**24070092.563**；**无 Wine32 未跑基线解**；交叉 [rtklib](./rtklib.md)/[pride-pppar](./pride-pppar.md)/[ginan](./ginan.md) |
| 93 | [rtppp-b2b.md](./rtppp-b2b.md) | 北斗 PPP-B2b 实时改正接口（BNC/SBF） | 191 | **已短硬** · tip **`9864c66`**；CRC **0**/`0x6131`；MT **1–7**；**缺 BNC 未链接**；交叉 [b2blib](./b2blib.md)/[navdecoder](./navdecoder.md)/[haslib](./haslib.md)/[cssrlib](./cssrlib.md)/[madocalib](./madocalib.md) |
