...
本目录共有 **80 篇**操作手册（合计 **18524 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 78 | [groops.md](./groops.md) | TU Graz 重力场 + GNSS（GROOPS；XML） | 215 | **已短硬** · tip **`7e1bd6d`**/发布 **2025-11-15**；编装 `groops`；Sp3 G01 **289** 历元；GRAZ **2880**/30；**未**全日 PPP（缺 dataDir）；交叉 [pride-pppar](./pride-pppar.md)/[ginan](./ginan.md)/[rtklib](./rtklib.md) |
| 79 | [rapppid.md](./rapppid.md) | VieVS MATLAB PPP（raPPPid） | 169 | **已短硬** · **v5.1**/tip **`28fd517`**；633 `.m`/9×`.mat`；**无 MATLAB** 未跑 GUI/解算；交叉 [pride-pppar](./pride-pppar.md)/[great-pvt](./great-pvt.md)/[rtklib](./rtklib.md) |
