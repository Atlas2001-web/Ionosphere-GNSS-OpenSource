...
本目录共有 **87 篇**操作手册（合计 **20163 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 85 | [ppp-wizard.md](./ppp-wizard.md) | CNES 整数零差 PPP-AR 示范（门户+SSR 产品） | 173 | **已短硬** · **质检复跑通过**（2026-09-24 05:41 EDT；`package.html` **404**；`cnt24373` SP3 **288**/109=G31+R19+E27+C32；CLK AS **1883520**；BIA **2268516** 行；解压≈**1.9/144/200 MB**；**无客户端包**未跑 PPP；交叉 [pride-pppar](./pride-pppar.md)/[rtklib](./rtklib.md)/[ginan](./ginan.md)/[great-pvt](./great-pvt.md)）|
| 86 | [gogps-matlab.md](./gogps-matlab.md) | goGPS MATLAB 低成本/多星座 PPP·NET | 197 | **已短硬** · **质检复跑通过**（2026-09-24 05:41 EDT；tip **`a990ed0`**/1.0.1；824 `.m`/427；ZIM3 **2880**/G01 C1C=**25131594.344**；**无 MATLAB** 未跑 GUI；交叉 [rtklib](./rtklib.md)/[graphgnsslib](./graphgnsslib.md)）|
