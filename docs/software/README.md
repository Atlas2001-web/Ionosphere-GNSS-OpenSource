...
本目录共有 **109 篇**操作手册（合计 **24193 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 105 | [pyrtklib.md](./pyrtklib.md) | 港理工 IPNL：RTKLIB 2.4.3 Python 绑定（pybind11） | 172 | **已短硬** · PyPI **0.2.7**/tip **`1c468db`**/`VER_RTKLIB` **2.4.3**；F9P `readrnx` **56934**；`pntpos` Q=**5**/ns=**4** → **22.320106847°N 114.211129029°E**；交叉 [rtklib](./rtklib.md)/[gnss_lib_py](./gnss_lib_py.md)/[graphgnsslib](./graphgnsslib.md)/[mrtklib](./mrtklib.md) |
| 106 | [mrtklib.md](./mrtklib.md) | 现代化 RTKLIB 系（CLAS/MADOCA/HAS/IGS；`mrtk`） | 167 | **已短硬** · tip **`8e09166`**/ **v0.7.10**；SPP **120**×Q5 与 apt b34 首点一致；RTK **120**×Q1 **35.160880512°N**；交叉 [rtklib](./rtklib.md)/[great-pvt](./great-pvt.md)/[ginan](./ginan.md)/[pride-pppar](./pride-pppar.md) |
| 107 | [ntrip-go.md](./ntrip-go.md) | Go NTRIP 库/云原生网关底座（go-gnss） | 220 | **已短硬** · tip **`6d11102`**/标签 **v0.0.16**；relay **8598110** B；`go test` **7 PASS**；源表 **766/384/918/1272**；本地 **200/401/404**；占位 **33** B；**未臆造 RTCM**；交叉 [ntrip-cpp](./ntrip-cpp.md)/[ntripclient](./ntripclient.md)/[ntripserver](./ntripserver.md)/[ntripcaster-libev](./ntripcaster-libev.md)/[bkg-ntripcaster](./bkg-ntripcaster.md)/[data-access](../data-access.md) |
...
最近新增（用法讲解）：**pyrtklib**（PyPI 0.2.7/`1c468db`/`VER_RTKLIB` 2.4.3；F9P readrnx 56934；pntpos 22.320106847N/114.211129029E Q5；交叉 rtklib/gnss_lib_py/graphgnsslib）+ **mrtklib**（`8e09166`/v0.7.10；SPP 120×Q5=apt b34；RTK 120×Q1 35.160880512N；交叉 rtklib/great-pvt/ginan/pride-pppar）。
...
5. 需要定位再 [rtklib](./rtklib.md)/[pyrtklib](./pyrtklib.md)/[mrtklib](./mrtklib.md)/[pride-pppar](./pride-pppar.md)
...
data-access
   ...
   └─ cssrlib / claslib / b2blib / rtppp-b2b / haslib / madocalib / laika / rtklib / pyrtklib / mrtklib / great-pvt / groops / rapppid / ppp-wizard / gogps-matlab / gsilib / pride-pppar (路径 D)
