...
| 97 | [ntripcaster-libev.md](./ntripcaster-libev.md) | libev NTRIP Broadcaster（自建播发） | 248 | **已短硬** · tip **`cc17929`**/`1.1.0`；口 **2101**；空表→**STR;LAB1**；`ICY 200`/`401`/`Bad Password`；**未臆造 RTCM**；交叉 [cors-relay](./cors-relay.md)/[bkg-ntripcaster](./bkg-ntripcaster.md)/[pygnssutils](./pygnssutils.md)/[data-access](../data-access.md)
| 98 | [iri-2026-package.md](./iri-2026-package.md) | 官方 IRI-2026 zip 发行物（清单/校验） | 155 | **已短硬** · zip **1823544**/sha₁₂=`2377b0c07a43`；系数已捆；指数另下；编译跑数→[iri-fortran](./iri-fortran.md)；交叉 [iri-common-files](./iri-common-files.md)/[pyiri](./pyiri.md)/[iri2016](./iri2016.md) |
| 99 | [iri-common-files.md](./iri-common-files.md) | IRI COMMON_FILES（CCIR/URSI 公共系数） | 150 | **已短硬** · `00_ccir-ursi.zip` **351482**/sha₁₂=`5427353c578f`；≤2016 必下 / 2020+ 已捆；交叉 [iri-2026-package](./iri-2026-package.md)/[iri-fortran](./iri-fortran.md)/[pyiri](./pyiri.md) |
...
最近新增（用法讲解）：**iri-2026-package**（zip 1823544/sha₁₂=`2377b0c07a43`；24×ccir/ursi 已捆；指数另下；不重跑 fort.7→引用 iri-fortran；交叉 iri-common-files/pyiri/iri2016）+ **iri-common-files**（`00_ccir-ursi.zip` 351482/sha₁₂=`5427353c578f`；≤2016 外置 vs 2020+ 内置；ccir11 byte=2026 包；交叉 iri-2026-package/iri-fortran/pyiri）。
...
data-access
   ...
   ├─ ntripbrowser / cors-relay / ntripcaster-libev / pygnssutils / ntripstreams / ntrip-client / bnc / bkg-ntripcaster (路径 C)
...
| 06 / 20 | cssrlib · haslib · madocalib · laika · gnss_lib_py · android_rinex · gps-measurement-tools · pygpsclient · pynmeagps · pyubx2 · ubx2rinex · pyrtcm · pyspartn · pysbf2 · septentrio-gnss-driver · ublox-dgnss · ublox-driver · ntripstreams · ntrip-client · cors-relay · ntripcaster-libev · glab-upc · rtklib · great-pvt · groops · rapppid · ppp-wizard · gogps-matlab · gsilib · rtppp-b2b · pride-pppar · ionomoni |
| 09 | pytecgg |
