...
本目录共有 **88 篇**操作手册（合计 **20395 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
最近新增（用法讲解）：**ublox_driver**（1.0.0/`7961ab7`；ROS1 catkin；launch×1/config×2；ublox_driver+sync_system_time；话题×7；无 ROS/无 Rx 门禁；交叉 ublox-dgnss/pyubx2/septentrio/swiftnav-ros2；下一优先 cors-relay）。
...
| 06 / 20 | cssrlib · haslib · madocalib · laika · gnss_lib_py · android_rinex · gps-measurement-tools · pygpsclient · pynmeagps · pyubx2 · ubx2rinex · pyrtcm · pyspartn · pysbf2 · septentrio-gnss-driver · ublox-dgnss · ublox-driver · ntripstreams · ntrip-client · glab-upc · rtklib · great-pvt · groops · rapppid · ppp-wizard · gogps-matlab · pride-pppar · ionomoni |
| 09 | pytecgg |
