...
本目录共有 **118 篇**操作手册（合计 **26016 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 117 | [galileo-nequick-g.md](./galileo-nequick-g.md) | GSC 官方 NeQuick-G C（登记墙） | 150 | **已短硬** · **登记受限**；0 zip/tar；EUPL+加密 zip；ICD **8461196** B；**未编译未臆造 TEC**；交叉 [nequickg](./nequickg.md)/[nequick2-ictp](./nequick2-ictp.md)/[iri-fortran](./iri-fortran.md) |
| 118 | [ionex.md](./ionex.md) | Python IONEX 读入（gnss-lab；≠ ionex-rs） | 159 | **已短硬** · tip **`8783a71`**/ **0.2**/无 PyPI；12 图/tec0=**9.8**/n_none=**287**；交叉 [ionex-rs](./ionex-rs.md)/[ionex-gim](./ionex-gim.md)/[georinex](./georinex.md)/[gnss-tec](./gnss-tec.md) |
...
最近新增（用法讲解）：**galileo-nequick-g**+**ionex**（2026-09-24 06:42 EDT；GSC 登记墙 0 zip；EUPL+加密 zip；ICD 8461196 B；未编译未臆造 TEC；ionex 0.2/`8783a71`；12 图/tec0=9.8/n_none=287；无 PyPI；交叉 nequickg/nequick2-ictp/iri-fortran · ionex-rs/ionex-gim/georinex/gnss-tec）。
