...
本目录共有 **97 篇**操作手册（合计 **21981 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 94 | [cors-relay.md](./cors-relay.md) | CORS/NTRIP 差分帐号池中继（libev） | 220 | **已短硬** · tip **`1238947`**/`123894`；8001–8003 + 管理 8000；STR×**3**；`ICY 200`/`401`；**无真源未臆造 RTCM**；交叉 [pygnssutils](./pygnssutils.md)/[bnc](./bnc.md)/[bkg-ntripcaster](./bkg-ntripcaster.md)/[ntripbrowser](./ntripbrowser.md)/[data-access](../data-access.md) |
| 95 | [iri-fortran.md](./iri-fortran.md) | 官方 IRI Fortran（irimodel.org） | 191 | **已短硬** · IRI-**2026**；fort.7 NmF2=**893124.7**/hmF2=**259.16**/TEC=**25.8**；交叉 [iri2016](./iri2016.md)/[pyiri](./pyiri.md)/[pyirtam](./pyirtam.md)/[nequickg](./nequickg.md) |
| 96 | [nequick2-ictp.md](./nequick2-ictp.md) | ICTP NeQuick 2 源码申请（≠NeQuick-G） | 150 | **已短硬** · **登记受限**；bnava@/yenca@；**无本地编译**；Web 表单可达；交叉 [nequickg](./nequickg.md)/[iri-fortran](./iri-fortran.md) |
...
data-access
   ...
   ├─ ntripbrowser / cors-relay / pygnssutils / ntripstreams / ntrip-client / bnc / bkg-ntripcaster (路径 C)
...
| 04 | iri-fortran · iri2016 · pyglow · pyiri · pyirtam · apexpy · aacgmv2 · msise00 · nequickg · nequick2-ictp · kamodo |
| 05 / 13 / 21 | oasis-roti · ionomoni · iono-scintillation · geospacelab |
| 06 / 20 | cssrlib · haslib · madocalib · laika · gnss_lib_py · android_rinex · gps-measurement-tools · pygpsclient · pynmeagps · pyubx2 · ubx2rinex · pyrtcm · pyspartn · pysbf2 · septentrio-gnss-driver · ublox-dgnss · ublox-driver · ntripstreams · ntrip-client · cors-relay · glab-upc · rtklib · great-pvt · groops · rapppid · ppp-wizard · gogps-matlab · gsilib · rtppp-b2b · pride-pppar · ionomoni |
| 09 | pytecgg |
