...
本目录共有 **133 篇**操作手册（合计 **29234 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 129 | [great-podflt.md](./great-podflt.md) | 武大实时滤波精密定轨 PODFLT（GREAT-WHU；SRIF） | 266 | **已短硬** · tip **`bd9fb71`**/★**17**；`great_podflt` **9641192** B；`-h` **0.9.0**；OpenMP 必开；`/<install_dir>/` 破 XML；空跑无 OBS→exit **1**/`great_podlflt.log`；参考 SP3 **16375106** B/**8641**；LFS `orb_*`；**未臆造** POD；交叉 [great-pce](./great-pce.md)/[clkcomb](./clkcomb.md)/[spocc](./spocc.md)/[data-access](../data-access.md) |
...
| 132 | [binex.md](./binex.md) | BINEX 编解码库（nav-solutions；纯库） | 244 | **已短硬** · crates **0.5.2**/tip **`9530237`**/MPL-2.0/★**5**/MSRV **1.85**；按页 decode ESBC **2642**/GLO **510**/SBAS **2129**；R01 clock=**6.355904042721001e-5**；交叉 [rinex2bin](./rinex2bin.md)/[rinex](./rinex.md)/[cggtts](./cggtts.md)/[rnx2cggtts](./rnx2cggtts.md) |
