...
本目录共有 **86 篇**操作手册（合计 **19925 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 82 | [ppp-wizard.md](./ppp-wizard.md) | CNES 整数零差 PPP-AR 示范（门户+SSR 产品） | 173 | **已短硬** · 门户/REAL_TIME；`package.html` **404**；**`cnt24373`** SP3 **288**/109 星；CLK AS **1883520**；BIA≈**2.27M**；**无客户端包**未跑 PPP；交叉 [pride-pppar](./pride-pppar.md)/[rtklib](./rtklib.md)/[ginan](./ginan.md)/[great-pvt](./great-pvt.md) |
| 83 | [gogps-matlab.md](./gogps-matlab.md) | goGPS MATLAB 低成本/多星座 PPP·NET | 197 | **已短硬** · tip **`a990ed0`**/`APP_VERSION=1.0.1`；824 `.m`/427 非 thirdParty；ZIM3 **2880** 历元 G01 C1C=**25131594.344**；**无 MATLAB** 未跑 GUI；交叉 [rtklib](./rtklib.md)/[graphgnsslib](./graphgnsslib.md) |
...
QC（[anubis](./anubis.md)/[gfzrnx](./gfzrnx.md)）→ [rtklib](./rtklib.md) 冒烟 →（可选 [ginan](./ginan.md) PPP/POD；[great-pvt](./great-pvt.md)；[groops](./groops.md)；[rapppid](./rapppid.md)；[ppp-wizard](./ppp-wizard.md)；[gogps-matlab](./gogps-matlab.md)；开放服务教学 [cssrlib](./cssrlib.md)；QZSS CLAS [claslib](./claslib.md)；QZSS MADOCA [madocalib](./madocalib.md)；B2b [b2blib](./b2blib.md)/[navdecoder](./navdecoder.md)）→ [pride-pppar](./pride-pppar.md) + 精密产品 → 教程 [06](../tutorials/06-iono-positioning.md)
...
6. 实时课再 [pygnssutils](./pygnssutils.md)/[ntripstreams](./ntripstreams.md)/[ntrip-client](./ntrip-client.md)/[pyrtcm](./pyrtcm.md)/[pyspartn](./pyspartn.md)/[pyubx2](./pyubx2.md)/[ubx2rinex](./ubx2rinex.md)/[septentrio-gnss-driver](./septentrio-gnss-driver.md)/[ublox-dgnss](./ublox-dgnss.md)/[pynmeagps](./pynmeagps.md)/[pygpsclient](./pygpsclient.md)/[bnc](./bnc.md)；教学定位拆解见 [glab-upc](./glab-upc.md)
...
data-access
   ...
   └─ cssrlib / claslib / b2blib / haslib / madocalib / laika / rtklib / great-pvt / groops / rapppid / ppp-wizard / gogps-matlab / pride-pppar (路径 D)
...
| 06 / 20 | cssrlib · haslib · madocalib · laika · gnss_lib_py · android_rinex · gps-measurement-tools · pygpsclient · pynmeagps · pyubx2 · ubx2rinex · pyrtcm · pyspartn · pysbf2 · septentrio-gnss-driver · ublox-dgnss · ntripstreams · ntrip-client · glab-upc · rtklib · great-pvt · groops · rapppid · ppp-wizard · gogps-matlab · pride-pppar · ionomoni |
| 09 | pytecgg |
