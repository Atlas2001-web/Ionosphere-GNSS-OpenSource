...
| 101 | [iri-matlab-fileexchange.md](./iri-matlab-fileexchange.md) | MathWorks File Exchange IRI（curl→CCMC；2012/2016） | 153 | **已短硬** · FX **2.0.0.0**/2019-12-07；**无 MATLAB**；vitmo→`IRI~2012/2016`；非 2026；交叉 [iri-fortran](./iri-fortran.md)/[iri-2026-package](./iri-2026-package.md)/[pyiri](./pyiri.md)/[gogps-matlab](./gogps-matlab.md) |
| 102 | [rtcm-ntrip-software.md](./rtcm-ntrip-software.md) | RTCM-Ntrip 官方软件门户（BNC/Caster/SVN 地图） | 172 | **已短硬** · WikiStart **2024-05-16**；SVN **r11044**；BKG **BNC 2.13.7**；交叉 [bnc](./bnc.md)/[bkg-ntripcaster](./bkg-ntripcaster.md)/[rtcm3torinex](./rtcm3torinex.md)/[pyrtcm](./pyrtcm.md)/[ntrip-client](./ntrip-client.md)/[ntripbrowser](./ntripbrowser.md)/[ntripstreams](./ntripstreams.md) |
