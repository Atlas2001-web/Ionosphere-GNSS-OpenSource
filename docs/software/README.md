...
本目录共有 **136 篇**操作手册（合计 **29823 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 133 | [gnssrefl.md](./gnssrefl.md) | GNSS-IR 反射测量（SNR→RH；Larson） | 184 | **已短硬** · PyPI **4.2.3**/tip **`e8d9cd0`**/★**219**；mchl **111** 弧/RH **1.6916** m；`quickLook` **0.0121°**；交叉 [georinex](./georinex.md)/[gfzrnx](./gfzrnx.md)/[rtklib](./rtklib.md)/[mpsim](./mpsim.md) |
| 134 | [mpsim.md](./mpsim.md) | GNSS 多路径前向仿真（Nievinski/Larson；MATLAB） | 204 | **已短硬** · tip **`61be627`**/BSD-2/★**48**；`.m` **1615**；Octave `snr_setup` OK/`snr_fwd` 失败；**无 MATLAB 未臆造 SNR**；交叉 [gnss-multipath-analysis](./gnss-multipath-analysis.md)/[gnssrefl](./gnssrefl.md)/[rtklib](./rtklib.md) |
| 135 | [rt-clk-service.md](./rt-clk-service.md) | 实时钟差/轨道/UPD/IFPB NTRIP 解码（DoubleString；SSR demo） | 201 | **已短硬** · tip **`1f44c36`**/★**12**/license=null；`ssr_acq` **539928** B/sha₁₂=`d5985dc96f1d`；仓内预置 **1187984** B；无 `-h`；硬编码 `usr:psd@103.143.19.54:2101/RTCM32SSR-COM`；`timeout 10` exit **124**/0 B；TCP:2101 超时；**未臆造** SSR；交叉 [great-podflt](./great-podflt.md)/[great-upd](./great-upd.md)/[clkcomb](./clkcomb.md)/[data-access](../data-access.md) |
...
QC（[anubis](./anubis.md)/[gfzrnx](./gfzrnx.md)）→ [rtklib](./rtklib.md) 冒烟 →（可选 [pyrtklib](./pyrtklib.md) 脚本批处理；[mrtklib](./mrtklib.md) CLAS/MADOCA/HAS；[ginan](./ginan.md) PPP/POD；[great-pvt](./great-pvt.md)；[groops](./groops.md)；[rapppid](./rapppid.md)；[ppp-wizard](./ppp-wizard.md)；[gogps-matlab](./gogps-matlab.md)；开放服务教学 [cssrlib](./cssrlib.md)；QZSS CLAS [claslib](./claslib.md)；QZSS MADOCA [madocalib](./madocalib.md)；B2b [b2blib](./b2blib.md)/[rtklib-b2b](./rtklib-b2b.md)/[navdecoder](./navdecoder.md)/[rtppp-b2b](./rtppp-b2b.md)；异机种 Win [gsilib](./gsilib.md)）→（可选码 OSB 网解 [mcosb](./mcosb.md)/[gkit-bias](./gkit-bias.md)；多 AC 轨道+钟综合 [spocc](./spocc.md)/[clkcomb](./clkcomb.md)；滤波 POD [great-podflt](./great-podflt.md)／实时 SSR [rt-clk-service](./rt-clk-service.md)）→ [pride-pppar](./pride-pppar.md) + 精密产品 → 教程 [06](../tutorials/06-iono-positioning.md)
...
data-access
   ...
   └─ cssrlib / claslib / b2blib / rtklib-b2b / rtppp-b2b / haslib / madocalib / laika / rtklib / rtklib-explorer / pyrtklib / mrtklib / great-pvt / great-pce / great-podflt / cube / clkcomb / groops / rapppid / ppp-wizard / gogps-matlab / gsilib / pride-pppar (路径 D)
