...
| 121 | [gnss-sdr.md](./gnss-sdr.md) | CTTC GNSS 软件定义接收机（IQ→PVT） | 166 | **已短硬** · Debian **0.0.20**/tip **`0f4dba1`**；仿真 IF→`Single` **41.275N/1.98757E**；12 PRN；NMEA **870**；无 RF；交叉 [pocketsdr](./pocketsdr.md)/[rtklib](./rtklib.md)/[georinex](./georinex.md)/[gps-measurement-tools](./gps-measurement-tools.md) |
| 122 | [pocketsdr.md](./pocketsdr.md) | Takasu PocketSDR 口袋式 GNSS SDR（v0.20） | 182 | **已短硬** · tip **`03787da`**/BSD-2；`USE_SOAPY=0`；`pocket_acq` CS16：**12**×C/N0≥40；无 FE；交叉 [gnss-sdr](./gnss-sdr.md)/[rtklib](./rtklib.md)/[gps-measurement-tools](./gps-measurement-tools.md)/[georinex](./georinex.md) |
