...
本目录共有 **81 篇**操作手册（合计 **37860 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 78 | [groops.md](./groops.md) | TU Graz 重力场 + GNSS（GROOPS；XML） | **已短硬** · **质检复跑通过**（2026-09-24 05:31 EDT；Sp3 G01 **289**/gaps=0；CLK 69182 B；GRAZ **2880**/30；`01`/`02` dataDir 边界；tip `7e1bd6d`） | **已短硬** · tip **`7e1bd6d`**/发布 **2025-11-15**；编装 `groops`；Sp3 G01 **289** 历元；GRAZ **2880**/30；**未**全日 PPP（缺 dataDir）；交叉 [pride-pppar](./pride-pppar.md)/[ginan](./ginan.md)/[rtklib](./rtklib.md) |
| 79 | [rapppid.md](./rapppid.md) | VieVS MATLAB PPP（raPPPid） | **已短硬** · **质检复跑通过**（2026-09-24 05:31 EDT；CODE **633** `.m`/9×`.mat`；OceanLoading 339510 B；无 MATLAB；tip `28fd517`/v5.1） | **已短硬** · **v5.1**/tip **`28fd517`**；633 `.m`/9×`.mat`；**无 MATLAB** 未跑 GUI/解算；交叉 [pride-pppar](./pride-pppar.md)/[great-pvt](./great-pvt.md)/[rtklib](./rtklib.md) |
| 80 | [piksi-tools.md](./piksi-tools.md) | Swift/Piksi 现场 SBP 工具（配 libsbp） | 212 | **已短硬** · PyPI **4.0.0**/tip **`02f1532`**；`serial_link --file` **61599** JSON；PosLLH CSV **4686**/≈37.7735°N；roundtrip n_sats=**15**；**无 Rx**；交叉 [libsbp](./libsbp.md)/[septentrio-gnss-driver](./septentrio-gnss-driver.md) |
| 81 | [swiftnav-ros2.md](./swiftnav-ros2.md) | Swift 官方 ROS 2 SBP 驱动 | 219 | **已短硬** · 包 **`swiftnav_ros2_driver` 1.0.0**/tip **`c35c6ef`**/tag **v1.0.0**；launch×**1**/config×**1**/msg×**1**；exec **`sbp-to-ros`**；**无 ROS/无 Rx** 未 colcon/launch；交叉 [libsbp](./libsbp.md)/[piksi-tools](./piksi-tools.md)/[septentrio-gnss-driver](./septentrio-gnss-driver.md) |
...
[pygnssutils](./pygnssutils.md) / [ntripstreams](./ntripstreams.md) / [ntrip-client](./ntrip-client.md) / [pyrtcm](./pyrtcm.md) / [rtcm3torinex](./rtcm3torinex.md) / [pyspartn](./pyspartn.md) / [pyubx2](./pyubx2.md) / [pysbf2](./pysbf2.md) / [septentrio-gnss-driver](./septentrio-gnss-driver.md) / [libsbp](./libsbp.md) / [piksi-tools](./piksi-tools.md) / [swiftnav-ros2](./swiftnav-ros2.md) / [pynmeagps](./pynmeagps.md) / [pygpsclient](./pygpsclient.md) 或 [bnc](./bnc.md) →（台站侧可选 [rtkbase](./rtkbase.md)；可选 [bkg-ntripcaster](./bkg-ntripcaster.md)）→ [rtklib](./rtklib.md)；落盘后再走 A/B；手机 Logger 见 [gps-measurement-tools](./gps-measurement-tools.md)+[android_rinex](./android_rinex.md)

### D · 发表级坐标 / ZTD

QC（[anubis](./anubis.md)/[gfzrnx](./gfzrnx.md)）→ [rtklib](./rtklib.md) 冒烟 →（可选 [ginan](./ginan.md) PPP/POD；[great-pvt](./great-pvt.md)；[groops](./groops.md)；[rapppid](./rapppid.md)；开放服务教学 [cssrlib](./cssrlib.md)；QZSS CLAS [claslib](./claslib.md)；QZSS MADOCA [madocalib](./madocalib.md)；B2b [b2blib](./b2blib.md)/[navdecoder](./navdecoder.md)）→ [pride-pppar](./pride-pppar.md) + 精密产品 → 教程 [06](../tutorials/06-iono-positioning.md)
...
最近新增（用法讲解）：**swiftnav-ros2**（`swiftnav_ros2_driver` 1.0.0/`c35c6ef`/v1.0.0；launch×1/config×1/msg×1；sbp-to-ros；无 ROS/无 Rx 门禁；交叉 libsbp/piksi-tools/septentrio-gnss-driver；下一优先 libswiftnav / ublox_dgnss）。最近新增（用法讲解）：**piksi_tools**（4.0.0/`02f1532`；serial_link JSON 61599；PosLLH 4686/≈37.7735N；roundtrip n_sats=15；无 Rx；交叉 libsbp；下一优先 swiftnav-ros2）。最近新增（用法讲解）：**groops**（`7e1bd6d`；Sp3 G01 289 历元；GRAZ 2880/30；未全日 PPP）+ **rapppid**（v5.1/`28fd517`；无 MATLAB；交叉 pride-pppar/great-pvt/rtklib）。最近新增（用法讲解）：**rtcm3torinex**（SVN r9404/WC r11044；2.9404；`make`；euref STR222；VALDM RINEX3 43 历元 G03 C1C=25238622.890；`-P` 75 行；rtk2go 400；obsolete→BNC；交叉 pyrtcm/bnc/pygnssutils/ntrip-client；下一优先 piksi_tools / swiftnav-ros2）。最近新增（质检）：**groops+rapppid 质检复跑通过**（2026-09-24 05:31 EDT；GROOPS Sp3 **289**/gaps=0；CLK 69182 B；GRAZ 2880/30；`01`/`02` 缺 tides/transmitterList；raPPPid CODE 633/树 635；无 MATLAB）。
...
6. 实时课再 [pygnssutils](./pygnssutils.md)/[ntripstreams](./ntripstreams.md)/[ntrip-client](./ntrip-client.md)/[pyrtcm](./pyrtcm.md)/[pyspartn](./pyspartn.md)/[pyubx2](./pyubx2.md)/[septentrio-gnss-driver](./septentrio-gnss-driver.md)/[pynmeagps](./pynmeagps.md)/[pygpsclient](./pygpsclient.md)/[bnc](./bnc.md)；教学定位拆解见 [glab-upc](./glab-upc.md)
...
data-access
   ...
   ├─ pygnssutils / ntripstreams / ntrip-client / bnc / bkg-ntripcaster (路径 C)
   └─ cssrlib / claslib / b2blib / haslib / madocalib / laika / rtklib / great-pvt / groops / rapppid / pride-pppar (路径 D)
...
| 06 / 20 | cssrlib · haslib · madocalib · laika · gnss_lib_py · android_rinex · gps-measurement-tools · pygpsclient · pynmeagps · pyubx2 · pyrtcm · pyspartn · pysbf2 · septentrio-gnss-driver · ntripstreams · ntrip-client · glab-upc · rtklib · great-pvt · groops · rapppid · pride-pppar · ionomoni |
| 09 | pytecgg |
