...
本目录共有 **135 篇**操作手册（合计 **29622 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 129 | [great-podflt.md](./great-podflt.md) | 武大实时滤波精密定轨 PODFLT（GREAT-WHU；SRIF） | 266 | **已短硬** · **质检复跑通过**（2026-09-24 07:17 EDT；tip **`bd9fb71`**/★**17**；bin **9639256** B；`-h` **0.9.0**@**07:10:57**；缺 XML/tags mismatch exit **1**；参考 SP3 **16375106**/**8641**/sha₁₂=`c22334bd0d0e`；LFS `orb_*`；**未臆造** POD；交叉 [great-pce](./great-pce.md)/[clkcomb](./clkcomb.md)/[spocc](./spocc.md)/[data-access](../data-access.md)）
...
| 131 | [cggtts.md](./cggtts.md) | CGGTTS 2E 解析/合成库（nav-solutions；纯库） | 270 | **已短硬** · crates **4.4.0**/tip **`fc75b91`**/MPL-2.0/★**18**/MSRV **1.82.0**；GZGTR **2097** 轨/G08 REFSV=**151304.2 ns**/ELV=**24.5°**/TRKL=**780 s**；ESBC 补丁后 **169**/G15 C1C REFSV=**258796.8 ns**/REFSYS=**480750.6 ns**/ELV=**70.8°**/TRKL=**960 s**；交叉 [rnx2cggtts](./rnx2cggtts.md)/[rinex2bin](./rinex2bin.md)/[clkcomb](./clkcomb.md)/[rinex](./rinex.md) |
| 132 | [binex.md](./binex.md) | BINEX 编解码库（nav-solutions；纯库） | 230 | **已短硬** · **质检复跑通过**（2026-09-24 07:17 EDT；**0.5.2**；glo3 **16384**/ok **4**/Geo×**3**+GLO×**1**/clock=**6.355904042721001e-5**；ESBC **10821632**/ok **2642**/GLO **510**+SBAS **2129**；`NoSyncByte`/`NotEnoughBytes`；enc **142**/**80**；交叉 [rinex2bin](./rinex2bin.md)/[cggtts](./cggtts.md)/[rinex](./rinex.md)）
