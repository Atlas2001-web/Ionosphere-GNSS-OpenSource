...
本目录共有 **83 篇**操作手册（合计 **19320 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 82 | [libswiftnav.md](./libswiftnav.md) | Swift GNSS 数值算法 C 库（星历/电离层等） | 260 | **已短硬** · tip **`19331e0`**/LGPL-3.0；CMake `libswiftnav.a`；gtest **250 PASSED**/24；`calc_ionosphere` **7.202448** m；对照 [libsbp](./libsbp.md)；交叉 [piksi-tools](./piksi-tools.md)/[swiftnav-ros2](./swiftnav-ros2.md)/[gnsstk](./gnsstk.md) |
| 83 | [ubx2rinex.md](./ubx2rinex.md) | u-blox UBX→RINEX 采集 CLI（nav-solutions） | 312 | **已短硬** · crates.io **0.3.0**/tip **`3b67fd0`**；F9T OBS **298**/G01 C1C=**21360867.696**；coldstart OBS **561**+NAV **9**；无 RAWX→0 文件；交叉 [pyubx2](./pyubx2.md)/[pygnssutils](./pygnssutils.md)/[georinex](./georinex.md)/[rinex-cli](./rinex-cli.md)/[android_rinex](./android_rinex.md) |
...
6. 实时课再 [pygnssutils](./pygnssutils.md)/[ntripstreams](./ntripstreams.md)/[ntrip-client](./ntrip-client.md)/[pyrtcm](./pyrtcm.md)/[pyspartn](./pyspartn.md)/[pyubx2](./pyubx2.md)/[ubx2rinex](./ubx2rinex.md)/[septentrio-gnss-driver](./septentrio-gnss-driver.md)/[pynmeagps](./pynmeagps.md)/[pygpsclient](./pygpsclient.md)/[bnc](./bnc.md)；教学定位拆解见 [glab-upc](./glab-upc.md)
...
| 06 / 20 | cssrlib · haslib · madocalib · laika · gnss_lib_py · android_rinex · gps-measurement-tools · pygpsclient · pynmeagps · pyubx2 · ubx2rinex · pyrtcm · pyspartn · pysbf2 · septentrio-gnss-driver · ntripstreams · ntrip-client · glab-upc · rtklib · great-pvt · groops · rapppid · pride-pppar · ionomoni |
| 09 | pytecgg |
