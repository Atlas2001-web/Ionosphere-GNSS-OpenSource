...
本目录共有 **60 篇**操作手册（合计 **14038 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 59 | [claslib.md](./claslib.md) | QZSS CLAS Compact SSR→OSR/VRS/PPP-RTK | 180 | **已短硬** · tip **`1e3a75d`**/tag **084**/README **0.8.4**；Linux `ssr2osr`；`-dump` header **3601**；`test1` **3580** GGA ≈36.1036°N 140.0863°E；交叉 [cssrlib](./cssrlib.md)/[madocalib](./madocalib.md)/[rtklib](./rtklib.md) |
| 60 | [b2blib.md](./b2blib.md) | 北斗 PPP-B2b C/C++ 解码（嵌 RTKLIB） | 187 | **已短硬** · tip **`fe7c4c0`**；Linux 自编 `rnx2rtkp`；WUH2 5 min **9**×Q=6；硬编码路径/`BOOL` 坑；交叉 [haslib](./haslib.md)/[cssrlib](./cssrlib.md)/[claslib](./claslib.md)/[madocalib](./madocalib.md)/[rtklib](./rtklib.md) |
