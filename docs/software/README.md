...
本目录共有 **75 篇**操作手册（合计 **17392 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 73 | [graphgnsslib.md](./graphgnsslib.md) | FGO 风格 GNSS/RTK（PolyU；ROS+Ceres） | 180 | **已短硬** · tip **`d861802`**；georinex+RTKLIB 基线；**无 ROS/Docker** 未跑 FGO；交叉 [rtklib](./rtklib.md)/[gnss_lib_py](./gnss_lib_py.md)/[great-pvt](./great-pvt.md) |
| 74 | [great-pvt.md](./great-pvt.md) | 武大 GREAT 精密 PVT（PPP/RTK，XML） | 183 | **已短硬** · **v1.4.0**/tip **`8bd3d23`**；GODN 1 h DF Float **120** 历元 3D RMS≈**0.006 m**；交叉 [pride-pppar](./pride-pppar.md)/[rtklib](./rtklib.md)/[ginan](./ginan.md) |
