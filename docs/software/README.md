...
本目录共有 **129 篇**操作手册（合计 **28247 行**，`wc -l`，不含本索引）：命令、输入输出、坑、选型。不是教材正文。
...
| 127 | [mcosb.md](./mcosb.md) | ECUT 多 GNSS 多频码 OSB（MCOSB；MATLAB/Octave） | 253 | **已短硬** · tip **`f9af2c0`**/★**11**；Octave GPS DOY001 G01 C1C=**9.5833**≡ECU `.BIA` **648** OSB；交叉 [gkit-bias](./gkit-bias.md)/[great-upd](./great-upd.md)/[data-access](../data-access.md) |
