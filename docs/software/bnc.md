...
目录：[`PROJECTS.json` → `BNC`](../../PROJECTS.json) · 官网 <https://igs.bkg.bund.de/ntrip/bnc> · FTP <https://igs.bkg.bund.de/root_ftp/NTRIP/software/BNC/> · 帮助 <https://software.rtcm-ntrip.org/export/HEAD/ntrip/trunk/BNC/src/bnchelp.html> · GPL-3.0
