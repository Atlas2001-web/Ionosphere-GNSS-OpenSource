...
目录：[`PROJECTS.json` → `cggtts`](../../PROJECTS.json) · 上游 <https://github.com/nav-solutions/cggtts> · crates.io **`cggtts` 4.4.0** · tip **`fc75b91`**（2026-09-08；仓内 `Cargo.toml` **4.4.0**/edition tip 2024，crates 发布 edition **2018**）· **MPL-2.0** · ★**18** · **无 [[bin]]**（纯库）· MSRV **1.82.0** · 本机验证 **rustc 1.98.1**（2026-09-24 07:09 EDT）：官方 fixture `GZGTR560.258` → tracks **2097**/G08 REFSV=**151304.2 ns**/ELV=**24.5°**/TRKL=**780 s**/MSIO 有；写回再读齐；`rnx2cggtts` 产物 ESBC `.ggs` 须改 VERSION 空格+XYZ ` m`+RCVR 三元组 + `from_file_infaillible_crc` → tracks **169**/G15@024600 C1C REFSV=**258796.8 ns**/REFSYS=**480750.6 ns**/ELV=**70.8°**/TRKL=**960 s**
