...
目录：[`PROJECTS.json` → `RTKLIB-explorer`](../../PROJECTS.json) · 上游 <https://github.com/rtklibexplorer/RTKLIB> · 博客/教程 <http://rtkexplorer.com/> · 手册 PDF <https://rtkexplorer.com/pdfs/manual_demo5.pdf> · tip **`06e8644`**（2026-08-31）· 产品串 **`rnx2rtkp RTKLIB EX 2.5.1`**（`VER_RTKLIB="EX"` / `PATCH_LEVEL="2.5.1"`）· 许可 **BSD-2-Clause**（`license.txt`，含 Takasu 版权）· 本机：`app/consapp/rnx2rtkp/gcc` + gcc **14.2.0** + `-lgfortran` → 二进制 **1115480** B；短样 SPP 3×Q=5；GSI 样例 SPP **120**×Q5 首点 **35.160874653°N 139.613828332°E h=70.5104**；RTK **115** 历元 Q1=**102**/Q2=**13**，首 fix **35.160872533°N 139.613836865°E h=69.8576** ratio≈**50.4** · **2026-09-24 06:30 EDT** · **质检复跑** 2026-09-24 06:33 EDT（tip **`06e8644`**/`rnx2rtkp ver.EX 2.5.1`/二进制 **1115480** B；GSI SPP **120**×Q5 首点 **35.160874653 139.613828332 70.5104**；RTK **115** 历元 Q1=**102**/Q2=**13**；首 Q1 **35.160872533 139.613836865 69.8576** ratio=**50.4**；交叉 [rtklib](./rtklib.md)/[pyrtklib](./pyrtklib.md)/[mrtklib](./mrtklib.md)/[rtklib-b2b](./rtklib-b2b.md)；**未改** rtklib/pyrtklib/mrtklib；**未臆造** PPC/UrbanNav 固定率）
