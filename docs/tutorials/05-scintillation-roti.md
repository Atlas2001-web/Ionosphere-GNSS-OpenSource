...
> **看图**：中间那档≈$r_F$ 时地面干涉最显眼。**误读**：凡有不规则体就断言强 S4。
...
> **看图**：事件窗可同现，但幅度账≠相位账。**误读**：高 TEC 夜=一定高 S4。
...
> - **看什么**：成片贴夜侧的高值斑，而非孤立单站毛刺。
> - **别误判**：示意场非实测 ROTI 产品；勿把色斑绝对值当 S4。
> 图源：本仓库自制示意场 + Natural Earth 海岸线（非实测事件）。

![亚太 ROTI 热点海岸图](./images/fig-roti-asia-coast.png)

> **看图要点**
> - **机制**：同一套日落后剧本，换到东亚—东南亚—西太平洋舞台；地方时叙事比纯 UTC 更贴。
