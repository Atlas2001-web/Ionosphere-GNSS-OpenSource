...
| 项目 | 一句话 | 语言 | ★ | 标记 |
|---|---|---|---:|---|
| [Multi_Sensor_Fusion](https://github.com/2013fangwentao/Multi_Sensor_Fusion) | GNSS/IMU/视觉等多源融合与 PPP/INS 紧组合 | C++ | 940 | 核心 |
| [GLIO](https://github.com/XikunLiu-huskit/GLIO) | GNSS/LiDAR/IMU 紧耦合连续定位 | C | 438 |  |
| [libRSF](https://github.com/TUC-ProAut/libRSF) | 面向在线定位的鲁棒传感器融合库 | C++ | 337 |  |
...
| [imu_x_fusion](https://github.com/cggos/imu_x_fusion) | 基于 ESKF/IEKF/UKF 的 IMU+GNSS/里程计松组合 | C++ | 1126 | 核心 |
...
| [nav_matlab](https://github.com/yandld/nav_matlab) | MATLAB 导航科学计算与组合导航例程 | MATLAB | 276 |  |
...
| [gnss_comm](https://github.com/HKUST-Aerial-Robotics/gnss_comm) | GNSS 原始测量处理的 ROS 基础定义与工具 | C++ | 164 |  |
| [ublox_driver](https://github.com/HKUST-Aerial-Robotics/ublox_driver) | 面向 ZED-F9P 的 ROS u-blox 驱动 | C++ | 159 |  |
...
| 项目 | 一句话 | 语言 | ★ | 标记 |
|---|---|---|---:|---|
| [TightlyCoupledINSGNSS](https://github.com/benzenemo/TightlyCoupledINSGNSS) | 伪距/伪距率与双天线测向的 INS/GNSS 紧组合（MATLAB） | MATLAB | 291 |  |
...
语言：MATLAB · 许可：BSD-2-Clause · 星标约：291
...
| 项目 | 一句话 | 语言 | ★ | 标记 |
|---|---|---|---:|---|
| [GVINS-Dataset](https://github.com/HKUST-Aerial-Robotics/GVINS-Dataset) | 视觉/惯性/GNSS 原始测量同步数据集 | C++ | 262 |  |

### 详细说明

#### [GVINS-Dataset](https://github.com/HKUST-Aerial-Robotics/GVINS-Dataset)

语言：C++ · 许可：NOASSERTION · 星标约：262
